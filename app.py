...
if st.button('Show Recommendation'):
    ...
    with col1:
        col1.text(recommended_movie_names[0])
        col1.image(recommended_movie_posters[0])
    with col2:
        col2.text(recommended_movie_names[1])
        col2.image(recommended_movie_posters[1])
    with col3:
        col3.text(recommended_movie_names[2])
        col3.image(recommended_movie_posters[2])
    with col4:
        col4.text(recommended_movie_names[3])
        col4.image(recommended_movie_posters[3])
    with col5:
        col5.text(recommended_movie_names[4])
